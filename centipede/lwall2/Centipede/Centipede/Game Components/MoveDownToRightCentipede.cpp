...
const MoveRightAndDownCentipede MoveFSM::StateMoveRightDown;
const MoveDownToLeftCentipede MoveFSM::StateMoveDownLeft;


MoveDownToRightCentipede::MoveDownToRightCentipede() {
...
const sf::Vector2f MoveDownToRightCentipede::GetScale(int i) const {
	if (i < 4) {
...
const MoveStateCentipede* MoveDownToRightCentipede::GetNextState(Centipede* centi,
...
const void MoveDownToRightCentipede::createMushroom(sf::Vector2f location,
	MushroomSpawner* mushGrid) const {
